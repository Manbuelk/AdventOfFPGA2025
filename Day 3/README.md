...
The module has two parameters, MAX_DECIMAL_SUMMED_PART_ONE and MAX_DECIMAL_SUMMED_PART_TWO, which set the maximum number of digits for the output of part one and two, respectively.
